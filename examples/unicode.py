...
"""
Test for printing of unicode in Python 2 and 3. It should print the word café.
...
but this breaks unicode printing in python2 when the codepage is 437, which
